class EntityTypesController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @entity_type.save
        format.html { redirect_to(@entity_type, :notice => 'EntityType was successfully created.') }
  ...
  def update
    ...
    respond_to do |format|
      if @entity_type.update_attributes(params[:entity_type])
        format.html { redirect_to(@entity_type, :notice => 'EntityType was successfully updated.') }
        format.xml  { head :ok }
      else
